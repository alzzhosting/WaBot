...
module.exports = {
  command: ["bluearchive", "blue-archive"],
  alias: ["bar"],
  category: ["anime", "game"],
  ...
  async run(m, { text, sock }) {
    try {
      ...
      let { data: characterData } = await axios.get(
        `https://api.ennead.cc/buruaka/character/${capitalize(text)}`,
      );
