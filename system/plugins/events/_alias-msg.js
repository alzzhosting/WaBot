...
async function events(m, { sock }) {
  sock.sendAliasMessage = async (jid, mess = {}, alias = {}, quoted = null) => {
    ...
    if (typeof sock.alias[jid] === "undefined") sock.alias[jid] = {};
  ...
  sock.sendInputMessage = async (
    ...
    if (typeof sock.input[jid] === "undefined") sock.input[jid] = {};
  ...
  if (typeof sock.alias === "undefined") sock.alias = {};
  if (typeof sock.input === "undefined") sock.input = {};
