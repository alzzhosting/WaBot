...
async function getAnimeDetails(link) {
  try {
    ...
    const judul = $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Judul"))
      .parent()
      .text()
      .trim()
      .split(": ")[1];
    const skor = $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Skor"))
      .parent()
      .text()
      .trim()
      .split(": ")[1];
    const produser = $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Produser"))
      .parent()
      .text()
      .trim()
      .split(": ")[1];
    const tipe = $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Tipe"))
      .parent()
      .text()
      .trim()
      .split(": ")[1];
    const status = $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Status"))
      .parent()
      .text()
      .trim()
      .split(": ")[1];
    const studio = $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Studio"))
      .parent()
      .text()
      .trim()
      .split(": ")[1];
    const rilis = $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Tanggal Rilis"))
      .parent()
      .text()
      .trim()
      .split(": ")[1];
    const episode = $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Total Episode"))
      .parent()
      .text()
      .trim()
      .split(": ")[1];
    ...
    const genreArray = [];
    $("div.infozingle span b")
      .filter((index, element) => $(element).text().includes("Genre"))
      .siblings("a")
      .each((index, element) => {
