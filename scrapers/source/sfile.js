...
module.exports = async (url) => {
  ...
  const { data: info, headers: responseHeaders } = await axios
    .get(url, {
      headers: headers,
    })
    .catch((e) => e.response);
