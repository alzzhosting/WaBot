  ...
  async load() {
    ...
    for (const filename of files) {
      ...
      try {
        ...
        console.log(
          chalk.redBright(`❌ Gagal memuat [ ${relativePath} ]: `) + e,
        );
    ...
    watcher
      .on("add", async (filename) => {
        ...
        try {
          ...
          console.log(
            chalk.cyanBright(`📥 Plugin baru terdeteksi: ${filename}`),
          );
          await this.load();
        } catch (e) {
          console.log(
      ...
      .on("change", async (filename) => {
        ...
        try {
          ...
          console.log(
            chalk.redBright(`❌ Gagal memperbarui [ ${relativePath} ]: `) + e,
          );
        }
      })
      .on("unlink", (filename) => {
